...
F.store_breakpoints = function(clear)
  if clear == nil then
    ...
    vim.notify_once(
      "The store_breakpoints function will not accept parameters in the future. If you want to clear all breakpoints, you should the use clear_all_breakpoints function.",
      "WARN"
    )
    if clear == true then
